...
def convert_pdf_to_text():
    ...
    if file_path:
        with open(file_path, 'rb') as pdf_file:
            print(f"start opening file {file_path}...")
            try :
                ...
                print(f"Done. PDF content appended to vault.txt with each chunk on a separate line.")
            except Exception as e:
                print(f"{RED_BACKGROUND}Failed to upload the file {file_path} {RESET_COLOR}")
                print(PINK + e.message + RESET_COLOR)
